...
runno={'N57433' , 'N57434', 'N57435', 'N57436', 'N57437', 'N57438', 'N57439', 'N57440', 'N57442', 'N57443'};

for ii=1:numel(runno)
    myname= char(runno(ii))

mysbatch_file=[clus_batch_directory char(runno(ii)) '_sync2.bash'];
fid=fopen(mysbatch_file, 'w');
fprintf(fid,'%s\n' ,shebang)
   
cmd1=['rsync -rpv /Volumes/delosspace-1/diffusion' char(runno(ii)) 'dsi_studio-results/nii4D_' char(runno(ii)) '.nii  /Volumes/dusom_abadea_nas1/19abb14'];
